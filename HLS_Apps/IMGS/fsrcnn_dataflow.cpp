...
///CORRELATION LAYERS
///----------------------------------------------------------------------------------------
void conrr_layer1(uint32_t  *img_input, stream256& corr1_out, uint32_t height, uint32_t width, uint32_t color){

	#pragma HLS INTERFACE mode=m_axi bundle=gmem depth=4096 port=img_input offset=slave
	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr1_out
...
void conrr_layer2(stream256& corr1_out, stream256& corr2_out, uint32_t height, uint32_t width, uint32_t color){

	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr1_out
	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr2_out
	#pragma HLS INTERFACE s_axilite port=height bundle=control
	#pragma HLS INTERFACE s_axilite port=width bundle=control
	#pragma HLS INTERFACE s_axilite port=color bundle=control
	#pragma HLS INTERFACE s_axilite port=return bundle=control
...
void conrr_layer3(stream256& corr2_out, stream256& corr3_out, uint32_t height, uint32_t width, uint32_t color){

	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr2_out
	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr3_out
	#pragma HLS INTERFACE s_axilite port=height bundle=control
	#pragma HLS INTERFACE s_axilite port=width bundle=control
	#pragma HLS INTERFACE s_axilite port=color bundle=control
	#pragma HLS INTERFACE s_axilite port=return bundle=control
...
void conrr_layer4(stream256& corr3_out, stream256& corr4_out, uint32_t height, uint32_t width, uint32_t color){

	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr3_out
	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr4_out
	#pragma HLS INTERFACE s_axilite port=height bundle=control
	#pragma HLS INTERFACE s_axilite port=width bundle=control
	#pragma HLS INTERFACE s_axilite port=color bundle=control
	#pragma HLS INTERFACE s_axilite port=return bundle=control
...
void conrr_layer5(stream256& corr4_out, stream256& corr5_out, uint32_t height, uint32_t width, uint32_t color){

	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr4_out
	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr5_out
	#pragma HLS INTERFACE s_axilite port=height bundle=control
	#pragma HLS INTERFACE s_axilite port=width bundle=control
	#pragma HLS INTERFACE s_axilite port=color bundle=control
	#pragma HLS INTERFACE s_axilite port=return bundle=control
...
void conrr_layer6(stream256& corr5_out, stream256& corr6_out, uint32_t height, uint32_t width, uint32_t color){

	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr5_out
	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr6_out
	#pragma HLS INTERFACE s_axilite port=height bundle=control
	#pragma HLS INTERFACE s_axilite port=width bundle=control
	#pragma HLS INTERFACE s_axilite port=color bundle=control
	#pragma HLS INTERFACE s_axilite port=return bundle=control
...
void conrr_layer7(stream256& corr6_out, stream256& corr7_out, uint32_t height, uint32_t width, uint32_t color){

	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr6_out
	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr7_out
	#pragma HLS INTERFACE s_axilite port=height bundle=control
	#pragma HLS INTERFACE s_axilite port=width bundle=control
	#pragma HLS INTERFACE s_axilite port=color bundle=control
	#pragma HLS INTERFACE s_axilite port=return bundle=control
...
///DECORRELATION LAYER
///----------------------------------------------------------------------------------------
void decorr_layer8(stream256& corr7_out, stream256& corr8_out, uint32_t height, uint32_t width, uint32_t scale_factor, uint32_t color){

	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr7_out
	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr8_out
	#pragma HLS INTERFACE s_axilite port=height bundle=control
	#pragma HLS INTERFACE s_axilite port=width bundle=control
...
void uncon_layer9(stream256& corr8_out, uint32_t *img_output, uint32_t height, uint32_t width, uint32_t color){

	#pragma HLS INTERFACE mode=m_axi bundle=gmem depth=16384 port=img_output offset=slave
	#pragma HLS INTERFACE mode=axis register_mode=both depth=229376 port=corr8_out
