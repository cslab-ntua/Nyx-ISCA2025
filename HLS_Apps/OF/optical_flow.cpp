...
void gradient_xy_calc(input_t frame[MAX_HEIGHT][MAX_WIDTH],	pixel_t gradient_x[MAX_HEIGHT][MAX_WIDTH], pixel_t gradient_y[MAX_HEIGHT][MAX_WIDTH]){
...
void gradient_z_calc(input_t frame1[MAX_HEIGHT][MAX_WIDTH], input_t frame2[MAX_HEIGHT][MAX_WIDTH], /*input_t frame3[MAX_HEIGHT][MAX_WIDTH],*/
    input_t frame4[MAX_HEIGHT][MAX_WIDTH], input_t frame5[MAX_HEIGHT][MAX_WIDTH], pixel_t gradient_z[MAX_HEIGHT][MAX_WIDTH]){
	...
	GRAD_Z_OUTER: for(int r=0; r<MAX_HEIGHT; r++){
		GRAD_Z_INNER: for(int c=0; c<MAX_WIDTH; c++){
      	  	#pragma HLS pipeline II=1
			gradient_z[r][c] =((pixel_t)(frame1[r][c]*GRAD_WEIGHTS[0]  + frame2[r][c]*GRAD_WEIGHTS[1] +
					/*frame3[r][c]*GRAD_WEIGHTS[2] +*/ frame4[r][c]*GRAD_WEIGHTS[3] + frame5[r][c]*GRAD_WEIGHTS[4]))/12;
...
void gradient_weight_y(pixel_t gradient_x[MAX_HEIGHT][MAX_WIDTH], pixel_t gradient_y[MAX_HEIGHT][MAX_WIDTH],
    pixel_t gradient_z[MAX_HEIGHT][MAX_WIDTH], gradient_t filt_grad[MAX_HEIGHT][MAX_WIDTH]){
...
void gradient_weight_x(gradient_t y_filt[MAX_HEIGHT][MAX_WIDTH], gradient_t filt_grad[MAX_HEIGHT][MAX_WIDTH]){
...
// tensor weight
void tensor_weight_y(outer_t outer[MAX_HEIGHT][MAX_WIDTH], tensor_t tensor_y[MAX_HEIGHT][MAX_WIDTH]){
...
void tensor_weight_x(tensor_t tensor_y[MAX_HEIGHT][MAX_WIDTH], tensor_t tensor[MAX_HEIGHT][MAX_WIDTH]){
...
void optical_flow(frames_t frames[MAX_HEIGHT * MAX_WIDTH], velocity_t outputs[MAX_HEIGHT * MAX_WIDTH]){
    ...
    gradient_z_calc(frame1_a, frame2_a, /*frame3_a,*/ frame4_a, frame5_a, gradient_z);
